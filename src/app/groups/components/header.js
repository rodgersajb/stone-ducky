...
export default function Header() {
    return (
         <HeaderFadeContainer className=" lg:h-dvh flex flex-col items-center justify-center gap-4 w-full relative text-white text-center">
                <Image
                  src="/images/ducky_restaurant_inside.webp"
                  alt="Ducky Restaurant Inside"
                  fill
                  priority={true}
                  className="-z-1 object-contain lg:object-cover brightness-75"
                />
