  ...
  return (
    <>
      ...
      <section className="w-full flex flex-col items-center justify-center gap-4 pb-8">
        ...
        />
        <h2 className="w-[95%] m-auto text-center text-xl lg:text-4xl">
      ...
      <div className="w-full px-8 m-auto flex flex-col items-center gap-8 py-8 bg-warmBeige" ref={formRef}>
        ...
        <p className="text-sm lg:w-3/4 text-center lg:text-lg">
          Fill out the form with your event details, and we'll take care of the
          rest. Stone Ducky Catering is here to make your gathering a delicious
          success. We’ll contact you by phone or email to iron out the details!
        </p>
      </div>
      <CateringForm />
    </>
